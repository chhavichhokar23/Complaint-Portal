...
import { LayoutDashboard, LogOut, ChevronLeft, ChevronRight, Users } from "lucide-react"
      ...
      <div>
        ...
        <nav className="flex flex-col gap-1">
          <Link
            href={dashboardHref}
            title="Dashboard"
            className={`flex items-center gap-3 rounded-lg text-sm text-slate-300 hover:bg-white/10 hover:text-white transition-colors group ${
